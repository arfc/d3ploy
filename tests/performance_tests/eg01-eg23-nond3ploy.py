...
input_file = '01-23-ND3.xml'
output_file = '01-23-ND3.sqlite'
name1 = '01-23-ND3_power'
name2 = '01-23-ND3_enrichmentout'
name2 = '01-23-ND3_mixerout'

with open(input_file, 'w') as f:
    f.write('<simulation>\n')
    f.write(control + archetypes)
    f.write(source + enrichment + lwr + fr + lwrstorage + frstorage)
    f.write(lwrreprocessing + frreprocessing + mixerlwr + mixerfr)
    f.write(lwrsink + frsink)
    f.write(region)
    f.write(recipe)
    f.write('</simulation>')
