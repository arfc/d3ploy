...
In each text file, the chi2 goodness of fit and supply falling below
demand results are shown and the best calc method is determined for
each type of results.
"""
...
back_commods = ['lwrstorageout',
                ...
                'frreprocessingoutpu', 'lwrreprocessingwaste',
                'frreprocessingwaste']
